...
#define FILM_WIDTH 1080 / 2
#define FILM_HEIGHT 720 / 2
...
int main()
{
    ...
    scene.addShape(sphere,
        {glm::vec3(0.8f, 1.0f, 0.4f), false, glm::vec3(0.0f, 0.0f, 0.0f)},
               glm::vec3(0.3f, 0.1f, 0.0f), glm::vec3(0.3f), glm::vec3(0.0f, 0.0f, 0.0f));
    scene.addShape(plane,
        {glm::vec3(0.4f, 0.8f, 1.0f), false, glm::vec3(0.0f, 0.0f, 0.0f)},
    ...
    scene.addShape(model,
        {glm::vec3(1.0f, 0.4f, 0.6f), false, glm::vec3(0.0f, 0.0f, 0.0f)},
    ...
    thread_pool.parallelFor(film.getWidth(), film.getHeight(), [&](size_t x, size_t y)->void
    {
        ...
        //     else
        //     {
        //         final_color = glm::vec3(1.0f, 0.0f, 0.0f);
        //         break;
        //     }
        // }
