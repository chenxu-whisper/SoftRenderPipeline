...
void Scene::addShape(Shape *shape, glm::vec3 position, glm::vec3 scale, glm::vec3 rotation)
{
    // 先将对象空间转换到世界空间
    ...
    m_shape_instances.push_back({shape, object_to_world_matrix, glm::inverse(object_to_world_matrix)});
}
